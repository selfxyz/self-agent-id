...
The base standard is intentionally minimal. It doesn't specify _how_ agents are verified or _who_ operates them. That's where optional extensions come in.
...
Any ZK identity system (Self Protocol, World ID, Humanity Protocol) can implement `IHumanProofProvider`. The registry doesn't care _how_ humanity is proven.
